...
class ImportBoundaryTestCase(unittest.TestCase):
    ...
    def test_plan_and_routing_import_no_openai_or_canvas(self):
        ...
        probe = (
            ...
            "import backend.services.pedagogy.assignment_debrief\n"
        ...
        self.assertEqual(
            result.stdout.strip(),
            "",
            f"plan/routing/coverage/coach_review/promote_back/ask/affect/debrief/assignment_debrief/drift/language_signal pulled forbidden modules: {result.stdout.strip()}",
        )
