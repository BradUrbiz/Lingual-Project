        ...
        {gameOver ? (
          ...
          <>
            ...
            <div className="rounded-xl border-2 border-border bg-secondary p-5 mb-5">
              <p className="text-sm text-muted-foreground mb-3">Tap play and choose what you hear:</p>
              <Button type="button" variant="accent" onClick={playPrompt} className="gap-2">
                <Volume2 size={18} />
                Play Audio
              </Button>
            </div>
