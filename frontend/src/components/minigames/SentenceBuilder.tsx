// SentenceBuilder - Warm Brutalism Edition
...
interface SentenceItem {
  sentence: string; // e.g. "저는 ___ 주세요."
  options: string[]; // e.g. ["물", "밥", "음악", "친구"]
  answer: string; // e.g. "물"
}
...
export function SentenceBuilder({ items, onClose }: SentenceBuilderProps) {
    ...
    return (
      ...
      >
        ...
        >
          ...
          <p className="text-muted-foreground mb-6">문장 완성 연습이 끝났어요!</p>
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="text-2xl font-display font-bold text-foreground">Sentence Builder</span>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="mb-8">
          <p className="text-2xl font-display font-bold text-foreground text-center mb-4">문장을 완성하세요!</p>
          <p className="text-xl text-center text-muted-foreground mb-2">{current.sentence}</p>
        </div>
